...
def TransportCarbonFootprintCalculator(root):
    ...
    distance_label = tk.Label(window, text="Distance (km):", bg="snow", width=20)
    ...
    efficiency_label = tk.Label(window, text="Fuel Efficiency (l/100km):", bg="snow", width=20)
    ...
    fuel_label = tk.Label(window, text="Fuel Type:", bg="snow", width=20)
    ...
    calculate_button = tk.Button(window, text="Calculate", command=calculate_emission, bg='snow', width=20)
    ...
    home_button = tk.Button(window, text="Home", command=go_home, bg="snow", width=20)
