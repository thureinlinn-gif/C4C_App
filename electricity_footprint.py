...
class ElectricityFootprintCalculator:
    def __init__(self, master):
        ...
        bg_label = tk.Label(self.top_level, image=bg_image, width=20)
        ...
        calculate_button = tk.Button(self.top_level, text="Calculate", command=self.calculate_footprint, bg="snow", width=20)
        calculate_button.pack(padx=10, pady=10)

        # Create a button to return to the home screen
        home_button = tk.Button(self.top_level, text="Home", command=self.go_home, bg="snow", width=20)
