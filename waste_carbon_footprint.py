...
def WasteEmissionCalculator(root):
    ...
    class WasteEmissionCalculator:
        ...
        def create_widgets(self):
            ...
            instruction_label = tk.Label(self.root, text="Please enter the weight of waste produced (in kg):", bg="snow")
            ...
            calculate_button = tk.Button(self.root, text="Calculate Carbon Footprint", command=self.calculate_carbon_footprint, bg='snow', width=20)
